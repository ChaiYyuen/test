...
def get_gptGenre_response():
  ...
  For each song, analyze the genre based on the artist's style and known characteristics. Output the result in JSON format with the song title and genre. Only in JSON format.
  """
